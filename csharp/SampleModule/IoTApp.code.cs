...
namespace SampleModule
{
    partial class IoTApp : IIoTApp
    {
        ...
        public async Task ReceivedE2DDataAsync(Message message, string inputPort)
        {
            Console.WriteLine($"Received E2D - {System.Text.Encoding.UTF8.GetString(message.GetBytes())} at {inputPort}");
